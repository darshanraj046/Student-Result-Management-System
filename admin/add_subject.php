...
<body>
    <div class="add">
        ...
        <form action="add_sub_action.php">
            ...
            <input type="text" id="fname" name="subject_name1" placeholder="Enter Subject-1 name">
            <br>
            <br>
            <label for="fname">Subject-2 Name</label>
            <input type="text" id="fname" name="subject_name2" placeholder="Enter Subject-2 name">
            <br>
            <br>
            <label for="fname">Subject-3 Name</label>
            <input type="text" id="fname" name="subject_name3" placeholder="Enter Subject-3 name">
            <br>
            <br>
            <label for="fname">Subject-4 Name</label>
            <input type="text" id="fname" name="subject_name4" placeholder="Enter Subject-4 name">
            <br>
            <br>
            <label for="fname">Subject-5 Name</label>
            <input type="text" id="fname" name="subject_name5" placeholder="Enter Subject-5 name">
            <br>
            <br>
            <label for="fname">Subject-6 Name</label>
            <input type="text" id="fname" name="subject_name6" placeholder="Enter Subject-6 name">
            <br>
            <br>
